...
import (
	...
	"github.com/openGemini/openGemini/app/ts-extra/geminicli"
...
const (
	...
	DEFAULT_PORT      = 8086
	DEFAULT_OPTSERVER = "localhost"
	DEFAULT_OPTPORT   = 8087
)
...
func init() {
	...
	//TODO: read from cmd
	rootCmd.Flags().StringVar(&options.OptServer, "os", DEFAULT_OPTSERVER, "opt server host")
	rootCmd.Flags().IntVar(&options.OptServerPort, "op", DEFAULT_OPTPORT, "opt server port")
}
